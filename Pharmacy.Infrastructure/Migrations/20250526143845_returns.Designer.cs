...
namespace Pharmacy.Infrastructure.Migrations
{
    ...
    [Migration("20250526143845_returns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Medicine.Medicine", b =>
                {
                    ...
                    b.Property<decimal?>("DosagePerKgForChildren")
                        .HasPrecision(4, 2)
                    ...
                    b.Property<bool>("IsUsedForChildren")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.SupplierInvoice.SupplierInvoiceItem", b =>
                {
                    ...
                    b.Property<decimal>("DistributorFixedMargin")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PharmacistFixedMargin")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Return.Return", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Return.ReturnItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.BalanceTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.Prescription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.PrescriptionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.PrescriptionTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PrescriptionTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Return.Return", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Wallets.Sales.Prescription", "Prescription")
                        .WithMany("Returns")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Return.ReturnItem", b =>
                {
                    b.HasOne("Pharmacy.Domain.Entities.Wallets.Sales.PrescriptionItem", "PrescriptionItem")
                        .WithMany()
                        .HasForeignKey("PrescriptionItemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Pharmacy.Domain.Entities.Wallets.Return.Return", "Return")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.BalanceTransaction", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Wallets.Sales.Prescription", "RelatedPrescription")
                        .WithMany()
                        .HasForeignKey("PrescriptionId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.Sales.PrescriptionTransaction", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Wallets.ShiftWallet", "ShiftWallet")
                        .WithMany("PrescriptionTransactions")
                        .HasForeignKey("ShiftWalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Wallets.ShiftWallet", b =>
                {
                    ...
                    b.Navigation("PrescriptionTransactions");
