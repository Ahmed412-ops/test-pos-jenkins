...
namespace Pharmacy.Infrastructure.Migrations
{
    ...
    [Migration("20250304112154_editmedicinecategorycoloum")]
    partial class editmedicinecategorycoloum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Medicine.Medicine", b =>
                {
                    ...
                    b.Property<Guid>("DefaultSellingUnitId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DefaultSellingUnitId");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Medicine.Medicine", b =>
                {
                    ...
                    b.HasOne("Pharmacy.Domain.Entities.Unit.Unit", "DefaultSellingUnit")
                        .WithMany()
                        .HasForeignKey("DefaultSellingUnitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("DefaultSellingUnit");
            ...
            modelBuilder.Entity("Pharmacy.Domain.Entities.Medicine.Medicine", b =>
                {
                    b.Navigation("AllowedSellingUnits");
